...
-- 4. Créer ou mettre à jour les fonctions
...
-- 5. Mettre à jour la fonction events_nearby pour inclure image_url
...
SELECT 'Correction des permissions terminée avec succès!' as status; 